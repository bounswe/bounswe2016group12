package test.java.com.irem;
import main.java.com.irem.Data;
import org.junit.BeforeClass;
import org.junit.Test;

import static org.junit.Assert.assertEquals;
/**
 * Created by Irem Zog on 09.05.2016.
 */
public class DataTest {


    private static Data tester;

    @BeforeClass
    public static void testSetup() {
        tester=new Data("https://query.wikidata.org/bigdata/namespace/wdq/sparql?query=" +
                "%23Cats%0" +
