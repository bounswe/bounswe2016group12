# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-11-03 15:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='relations', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='topictags', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        ...
        migrations.AlterUniqueTogether(
            name='topicnamevoter',
            unique_together=set([('user', 'topic_name'), ('topic', 'topic_name'), ('topic', 'user')]),
        ),
        migrations.AlterUniqueTogether(
            name='topicname',
        ...
        migrations.AlterUniqueTogether(
            name='relationlabelvoter',
            unique_together=set([('user', 'relation_label')]),
        ),
        migrations.AlterUniqueTogether(
            name='relationlabel',
        ...
        migrations.AlterUniqueTogether(
            name='commentvoter',
            unique_together=set([('user', 'comment_version'), ('user', 'comment')]),
        ),
        migrations.AlterUniqueTogether(
            name='commentversion',
